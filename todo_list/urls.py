...
from .views import DeleteTaskView, LoginView, TasksViewList, TaskDetailView, CreateTaskView, UpdateTaskView, UserCreationView
...
urlpatterns = [
    ...
    path('regester/', UserCreationView.as_view(), name='regester'),
